...
public class SideMenuPanelManager {
	...
	public SideMenuPanelManager(JFrame frame) {
	...
	public void setSide(SideMenuPanel side) {
		this.side = side;
	}
				...
				public void run() {
					for (int i = maxWidth; i >= 0; i -= speed) {
						try {
							...
							Logger.getLogger(SideMenuPanelManager.class.getName()).log(Level.SEVERE, null, ex);
						}
					}
					getSide().closePanel(minWidth);
					closeMenu();
				}
	...
	private void setPanelSize(int size) {
		...
		gl.setHorizontalGroup(gl.createParallelGroup(GroupLayout.Alignment.LEADING)
				.addGroup(gl.createSequentialGroup()
						.addComponent(side, GroupLayout.PREFERRED_SIZE, size,
								GroupLayout.PREFERRED_SIZE)
						.addGap(0, 0, 0).addComponent(main, GroupLayout.DEFAULT_SIZE,
								GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
						.addGap(0, 0, 0)));
		gl.setVerticalGroup(gl.createParallelGroup(GroupLayout.Alignment.LEADING)
				.addComponent(side, GroupLayout.Alignment.TRAILING, GroupLayout.DEFAULT_SIZE,
						558, Short.MAX_VALUE)
				.addComponent(main, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE,
						Short.MAX_VALUE));
	}
}