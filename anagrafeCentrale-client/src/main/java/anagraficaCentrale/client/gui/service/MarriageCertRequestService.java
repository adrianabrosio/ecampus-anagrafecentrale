...
public class MarriageCertRequestService extends CertificateRequestService {
	...
	protected String getFileDisplayName() {
		return GUIConstants.LANG.lbl_CERT_MATR_ReportDisplayName;
	}

	@Override
	protected String getFileTitle() {
		return GUIConstants.LANG.lbl_CERT_MATR_ReportTitle;
	}

	@Override
	protected String getFileContent() {
		String fileContent = GUIConstants.LANG.lbl_CERT_MATR_ReportContent;
